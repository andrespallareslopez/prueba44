...
SystemJS.config({
    ...
    map:{
        ...
        'wcinputmask':'/src/lib/MyInputMask.js',
        'wcinputdate':'/src/lib/MyInputDate.js',
        'wcinputdatetime':'/src/lib/MyInputDateTime.js',
        'wcinputcurrency':'/src/lib/MyInputCurrency.js',
        'wcinputcreditcard':'/src/lib/MyInputCreditCard.js',
